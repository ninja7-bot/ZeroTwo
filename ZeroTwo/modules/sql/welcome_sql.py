...
from ZeroTwo.modules.helper_funcs.msg_types import Types
...
DEFAULT_WELCOME_MESSAGES = [
    ...
    "I'm looking for Garo, oh wait nvm it's {first}.",  # One kick man s2
    "Welcome {first}, leaving is not an option!",
    "Run Forest! ..I mean...{first}.",
    "{first} do 100 push-ups, 100 sit-ups, 100 squats, and 10km running EVERY SINGLE DAY!!!",  # One kick ma
    "Huh?\nDid someone with a disaster level just join?\nOh wait, it's just {first}.",  # One kick ma
    "Hey, {first}, ever heard the King Engine?",  # One kick ma
