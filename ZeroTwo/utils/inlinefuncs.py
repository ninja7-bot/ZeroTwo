...
from ZeroTwo import ZeroTwoTelethonClient as app
from ZeroTwo import arq
from ZeroTwo.services.keyboard import Ikb
from ZeroTwo.utils.pluginhelper import (
    convert_seconds_to_minutes as time_convert,
    fetch,
)
from ZeroTwo.services.tasks import _get_tasks_text, all_tasks, rm_task
from ZeroTwo.services.types import InlineQueryResultCachedDocument
from ZeroTwo.modules.info import get_chat_info, get_user_info
from ZeroTwo.modules.music import download_youtube_audio
from ZeroTwo.utils.functions import test_speedtest
from ZeroTwo.utils.pastebin import paste
...
async def test_speedtest_cq(_, cq):
    if cq.from_user.id not in MOD_USERS:
