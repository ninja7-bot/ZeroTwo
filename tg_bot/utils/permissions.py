...
from tg_bot import DRAGONS, MOD_USERS, WOLVES, DEMONS, REAPERS
from tg_bot.utils.adminperms import member_permissions

SUDO = DRAGONS, MOD_USERS, WOLVES, DEMONS, REAPERS
