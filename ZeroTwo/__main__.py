...
PM_START_TEXT = """
Welcome User: {}!
With great pleasure am I, {}, present before you!

To assist you in moderating your group with some fun to have modules equipped, am a perfect bot.
All the logs are completely public and my Moderators are also enlisted. In case of any abuse or any issue with the bot, a Support Chat is also in place.
"""
...
buttons = [
    [
        InlineKeyboardButton(
            text="Add to Group!",
            url="https://t.me/MissZeroTwoBot?startgroup=new",
        ),
    ],
    [
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("ZeroTwo.modules." + module_name)
...
def bot_about_callback(update, context):
    ...
    if query.data == "bot_":
        query.message.edit_text(
            ...
            "\n I possess a whole module specifically for *Anime* commands, a lot many developments are yet to come. Stay tuned and Enjoy the ride with me!"
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(
        bot_about_callback, pattern=r"bot_", run_async=True
    )
