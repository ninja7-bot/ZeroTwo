...
BLACKLISTWHITELIST = [OWNER_ID] + MOD_USERS + SUDOS + HELLHOUND + REAPERS
BLABLEUSERS = [OWNER_ID] + MOD_USERS
...
def __user_info__(user_id):
    ...
    if user_id == dispatcher.bot.id:
        return ""
    if int(user_id) in SUDOS + REAPERS + HELLHOUND:
        return ""
    if is_blacklisted:
