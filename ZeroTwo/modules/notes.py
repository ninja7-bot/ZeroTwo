...
import ZeroTwo.modules.sql.notes_sql as sql
from ZeroTwo import LOGGER, JOIN_LOGGER, SUPPORT_CHAT, dispatcher, SUDOS
from ZeroTwo.modules.disable import DisableAbleCommandHandler
from ZeroTwo.modules.helper_funcs.handlers import MessageHandlerChecker
from ZeroTwo.modules.helper_funcs.chat_status import user_admin, connection_status
from ZeroTwo.modules.helper_funcs.misc import build_keyboard, revert_buttons
from ZeroTwo.modules.helper_funcs.msg_types import get_note_type
from ZeroTwo.modules.helper_funcs.string_handling import (
...
def clearall(update: Update, context: CallbackContext):
    ...
    if member.status != "creator" and user.id not in SUDOS:
...
def clearall_btn(update: Update, context: CallbackContext):
    ...
    if query.data == "notes_rmall":
        if member.status == "creator" or query.from_user.id in SUDOS:
