...
if is_module_loaded(FILENAME):
    ...
    from ZeroTwo import EVENT_LOGS, LOGGER, dispatcher
    from ZeroTwo.modules.helper_funcs.chat_status import user_admin
    from ZeroTwo.modules.sql import log_channel_sql as sql
        ...
        def log_action(
            ...
            **kwargs,
            ...
            if result:
                ...
                result += f"\n<b>Event Stamp</b>: <code>{datetime.istnow().strftime(datetime_fmt)}</code>"
        ...
        def glog_action(update: Update, context: CallbackContext, *args, **kwargs):
            ...
            if result:
                ...
                result += "\n<b>Event Stamp</b>: <code>{}</code>".format(
                    datetime.istnow().strftime(datetime_fmt)
                )
