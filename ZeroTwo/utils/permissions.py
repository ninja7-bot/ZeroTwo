...
from ZeroTwo import SUDOS, MOD_USERS, HELLHOUND, REAPERS, RONIN
from ZeroTwo.utils.adminperms import member_permissions

SUDO = SUDOS, MOD_USERS, HELLHOUND, REAPERS, RONIN
