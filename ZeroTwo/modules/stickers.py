...
from ZeroTwo.services.convert import convert_gif 
...
# convert gif method
    ...
    if msg.reply_to_message:
        if msg.reply_to_message.sticker:
            ...
            msg.reply_text("Sorry seems like Zero Two is unable to kang it  :(")
...
def makepack_internal(
    ...
    keyboard = InlineKeyboardMarkup(
        [[InlineKeyboardButton(text="Sticker Pack", url=f"{packname}")]]
    )
    try:
        extra_version = ""
        if packnum > 0:
