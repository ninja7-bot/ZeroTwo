...
from ZeroTwo import ALLOW_EXCL, CustomCommandHandler, dispatcher
...
from ZeroTwo.modules.sql import cleaner_sql as sql
 ...
 *Following are [Class] only commands, admins cannot use these:*
