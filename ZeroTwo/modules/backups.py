...
from ZeroTwo import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from ZeroTwo.__main__ import DATA_IMPORT
...
def export_data(update, context):
    ...
    with open("KyoukoHori{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("KyoukoHori{}.backup".format(chat_id), "rb"),
    ...
    os.remove("KyoukoHori{}.backup".format(chat_id))  # Cleaning file
