...
from ZeroTwo.modules.sudoers import bot_sys_stats
...
from ZeroTwo import StartTime, dispatcher, ZeroTwoTelethonClient
...
PING_IMG = "https://wallpapercave.com/wp/wp3025548.jpg"
    ...
    update.effective_message.reply_photo(
        ...
        parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
                [
                  [
                  InlineKeyboardButton(text="Zero Two System Stats", callback_data="stats_callback")
                  ]
                ]
            ),
        )
...
@ZeroTwoTelethonClient.on_callback_query(filters.regex("stats_callback"))
async def stats_callback(_, CallbackQuery):
    text = await bot_sys_stats()
    await ZeroTwoTelethonClient.answer_callback_query(CallbackQuery.id, text, show_alert=True)
