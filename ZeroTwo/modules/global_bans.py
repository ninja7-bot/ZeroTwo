...
import ZeroTwo.modules.sql.global_bans_sql as sql
from ZeroTwo import (
    REAPERS,
    MOD_USERS,
    SUDOS,
...
def gban(update: Update, context: CallbackContext):
    ...
    if EVENT_LOGS:
        ...
        send_to_list(bot, SUDOS + REAPERS, log_message, html=True)
        ...
        try:
            ...
            if excp.message in GBAN_ERRORS:
                ...
                if EVENT_LOGS:
                    ...
                    send_to_list(
                        bot, SUDOS + REAPERS, f"Could not gban due to: {excp.message}"
                    )
...
def ungban(update: Update, context: CallbackContext):
    ...
    if EVENT_LOGS:
        ...
        send_to_list(bot, SUDOS + REAPERS, "un-gban complete!")
...
def __user_info__(user_id):
    ...
    if user_id == NEKO_PTB.bot.id:
        return ""
    if int(user_id) in SUDOS + RONIN + HELLHOUND:
        return ""
    if is_gbanned:
